...
__decorate([
    ...
    (0, class_validator_1.Validate)((o) => o.type === [constants_1.JSON_TYPE.MECHANICAL_PROPERTY] ||
        o.type === [constants_1.JSON_TYPE.CHEMICAL_PROPERTY] ||
        o.type === [constants_1.JSON_TYPE.GAS_PROPERTY]),
