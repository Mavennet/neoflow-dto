...
exports.CORE_DRAFT_USMCADTO = exports.CORE_GENERATED_USMCADTO = exports.CORE_USMCADTO = exports.AGENT_USMCADTO = void 0;
...
], CORE_USMCADTO.prototype, "index", void 0);
__decorate([
    (0, class_validator_1.IsNotEmptyObject)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => contactForm_dto_1.ContactFormDTO),
...
class CORE_GENERATED_USMCADTO extends CORE_USMCADTO {
    certificationVC;
}
exports.CORE_GENERATED_USMCADTO = CORE_GENERATED_USMCADTO;
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.ValidateNested)(),
...
], CORE_GENERATED_USMCADTO.prototype, "certificationVC", void 0);
class CORE_DRAFT_USMCADTO {
    index;
    certifierDetails;
    exporterDetails;
    producerDetails;
...
exports.CORE_DRAFT_USMCADTO = CORE_DRAFT_USMCADTO;
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], CORE_DRAFT_USMCADTO.prototype, "index", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => contactForm_dto_1.DraftContactFormDTO),
    (0, swagger_1.ApiProperty)({ required: false }),
    __metadata("design:type", contactForm_dto_1.DraftContactFormDTO)
], CORE_DRAFT_USMCADTO.prototype, "certifierDetails", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => contactForm_dto_1.DraftContactFormDTO),
    (0, swagger_1.ApiProperty)({ required: false }),
    __metadata("design:type", contactForm_dto_1.DraftContactFormDTO)
], CORE_DRAFT_USMCADTO.prototype, "exporterDetails", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => contactForm_dto_1.DraftContactFormDTO),
    (0, swagger_1.ApiProperty)({ required: false }),
    __metadata("design:type", contactForm_dto_1.DraftContactFormDTO)
], CORE_DRAFT_USMCADTO.prototype, "producerDetails", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => contactForm_dto_1.DraftContactFormDTO),
    (0, swagger_1.ApiProperty)({ required: false }),
    __metadata("design:type", contactForm_dto_1.DraftContactFormDTO)
], CORE_DRAFT_USMCADTO.prototype, "importerDetails", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => goods_dto_1.DraftGoodsDTO),
    (0, swagger_1.ApiProperty)({ isArray: true, type: goods_dto_1.DraftGoodsDTO, required: false }),
    __metadata("design:type", Array)
], CORE_DRAFT_USMCADTO.prototype, "goods", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CORE_DRAFT_USMCADTO.prototype, "variousProducers", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, class_validator_1.IsDateString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Object)
], CORE_DRAFT_USMCADTO.prototype, "validFrom", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, class_validator_1.IsDateString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Object)
], CORE_DRAFT_USMCADTO.prototype, "validUntil", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CORE_DRAFT_USMCADTO.prototype, "certificationId", void 0);
