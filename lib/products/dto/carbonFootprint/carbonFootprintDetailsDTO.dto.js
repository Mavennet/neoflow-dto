...
__decorate([
    swagger_1.ApiPropertyOptional({ type: () => _1.ProcessEmissionDTO }),
...
__decorate([
    swagger_1.ApiPropertyOptional({ type: () => _1.StationaryCombustionDTO }),
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested(),
...
__decorate([
    swagger_1.ApiPropertyOptional({ type: () => _1.MobileCombustionUsageDTO }),
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested(),
...
__decorate([
    swagger_1.ApiPropertyOptional({ type: () => _1.MobileCombustionDistanceDTO }),
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested(),
...
__decorate([
    swagger_1.ApiPropertyOptional({ type: () => _1.PurchasedElectricityDTO }),
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested(),
...
__decorate([
    swagger_1.ApiPropertyOptional({ type: () => _1.CarbonFootprintEventsDTO }),
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => _1.CarbonFootprintEventsDTO),
