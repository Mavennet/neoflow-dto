...
const dto_1 = require("../../events/dto");
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => dto_1.TransportationEventDetailsDTO),
    __metadata("design:type", dto_1.TransportationEventDetailsDTO)
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => dto_1.OGBillOfLadingVCDTO),
    __metadata("design:type", dto_1.OGBillOfLadingVCDTO)
...
__decorate([
    ...
    (0, class_validator_1.ValidateNested)(),
    (0, class_validator_1.ValidateIf)((o) => o.eventType === constants_1.TRANSPORT_EVENT_TYPE.START),
    (0, class_transformer_1.Type)(() => dto_1.TransportationEventCredentialSubjectDTO),
    __metadata("design:type", dto_1.TransportationEventCredentialSubjectDTO)
], TransportProductDTO.prototype, "transportCredentialSubject", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_validator_1.ValidateIf)((o) => o.eventType === constants_1.TRANSPORT_EVENT_TYPE.END),
    (0, class_transformer_1.Type)(() => dto_1.OGBillOfLadingCredentialSubjectDTO),
    __metadata("design:type", dto_1.OGBillOfLadingCredentialSubjectDTO)
