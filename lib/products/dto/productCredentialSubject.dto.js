...
class ProductCredentialSubjectDTOBase extends traceability_dto_1.ProductCredentialSubjectDTO {
}
__decorate([
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ArrayNotEmpty)(),
    (0, class_validator_1.IsEnum)(constants_1.JSON_TYPE_NF, { each: true }),
    (0, class_validator_1.Validate)((o) => o.type === [constants_1.JSON_TYPE_NF.CRUDE_OIL_PRODUCT] || o.type === [constants_1.JSON_TYPE_NF.NATURAL_GAS_PRODUCT]),
    (0, swagger_1.ApiProperty)({ enum: constants_1.JSON_TYPE_NF, isArray: true }),
...
], ProductCredentialSubjectDTOBase.prototype, "inspection", void 0);
