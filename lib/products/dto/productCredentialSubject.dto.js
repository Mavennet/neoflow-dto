...
__decorate([
    ...
    (0, class_validator_1.Validate)((o) => o.type.includes(constants_1.JSON_TYPE_NF.CRUDE_OIL_PRODUCT) || o.type.includes(constants_1.JSON_TYPE_NF.NATURAL_GAS_PRODUCT)),
...
__decorate([
    ...
    (0, swagger_1.ApiProperty)({ isArray: true, type: dto_1.ObservationDTO }),
    __metadata("design:type", Array)
