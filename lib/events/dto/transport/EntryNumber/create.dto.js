...
exports.CORE_CreateEntryNumberDTO_OIL = exports.CORE_CreateEntryNumberDTO = exports.CreateEntryNumberDTO = exports.CreateEntryNumberDTOBase = void 0;
...
class CORE_CreateEntryNumberDTO_OIL extends CreateEntryNumberDTOBase {
    eventId;
    eventVC;
}
exports.CORE_CreateEntryNumberDTO_OIL = CORE_CreateEntryNumberDTO_OIL;
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CORE_CreateEntryNumberDTO_OIL.prototype, "eventId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => _1.EntryNumberEventVCDTO),
    __metadata("design:type", _1.EntryNumberEventVCDTO)
], CORE_CreateEntryNumberDTO_OIL.prototype, "eventVC", void 0);
