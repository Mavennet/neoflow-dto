...
exports.CORE_DeliveryScheduledDTO = exports.AGENT_DeliveryScheduledDTO = exports.DeliveryScheduledVCDTO = exports.DeliveryScheduledCredentialSubjectDTO = void 0;
...
__decorate([
    ...
    (0, class_validator_1.Equals)(constants_1.JSON_TYPE_NF.DELIVERY_SCHEDULE),
...
__decorate([
    ...
    (0, swagger_1.ApiPropertyOptional)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => traceability_dto_1.CommodityDTO),
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, swagger_1.ApiPropertyOptional)({ isArray: true, type: () => traceability_dto_1.MeasurementDTO }),
...
class DeliveryScheduledVCDTO extends traceability_dto_1.CredentialDTO {
    credentialSubject;
}
