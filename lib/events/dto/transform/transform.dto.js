...
const successor_dto_1 = require("../../../products/dto/successor.dto");
...
__decorate([
    ...
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => successor_dto_1.SuccessorDTO),
    __metadata("design:type", Array)
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.ValidateNested)(),
    (0, class_transformer_1.Type)(() => event_vc_dto_1.AGENT_TransformationEventDetailsDTO),
    __metadata("design:type", event_vc_dto_1.AGENT_TransformationEventDetailsDTO)
...
__decorate([
    ...
    __metadata("design:type", Array)
], AGENT_TransformProductsDTO.prototype, "productSuccessors", void 0);
__decorate([
    (0, swagger_1.ApiProperty)(),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ArrayMinSize)(1),
