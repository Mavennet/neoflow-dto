...
exports.CORE_AddEntryDetailsCredentialSubjectDTO = exports.BASE_AddEntryDetailsCredentialSubject = exports.AGENT_AddEntryDetailsCredentialSubjectDTO = void 0;
...
class BASE_AddEntryDetailsCredentialSubject extends AGENT_AddEntryDetailsCredentialSubjectDTO {
}
__decorate([
    class_validator_1.IsArray(),
    class_validator_1.ArrayMinSize(1),
    __metadata("design:type", Array)
], BASE_AddEntryDetailsCredentialSubject.prototype, "@context", void 0);
exports.BASE_AddEntryDetailsCredentialSubject = BASE_AddEntryDetailsCredentialSubject;
...
__decorate([
    ...
    __metadata("design:type", String)
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "eventTime", void 0);
__decorate([
...
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "portOfEntry", void 0);
__decorate([
    class_validator_1.IsNotEmptyObject(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => general_1.OrganizationDTO),
    __metadata("design:type", general_1.OrganizationDTO)
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "carrier", void 0);
__decorate([
    class_validator_1.IsNotEmptyObject(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => general_1.OrganizationDTO),
    __metadata("design:type", general_1.OrganizationDTO)
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "recipient", void 0);
__decorate([
    class_validator_1.IsNotEmptyObject(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => general_1.PlaceDTO),
    __metadata("design:type", general_1.PlaceDTO)
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "portOfDestination", void 0);
__decorate([
    class_validator_1.IsNotEmptyObject(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => mavennet_dto_1.ParcelDeliveryDTO),
    __metadata("design:type", mavennet_dto_1.ParcelDeliveryDTO)
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "shipment", void 0);
__decorate([
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsDateString(),
    __metadata("design:type", String)
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "expectedDeliveryDate", void 0);
__decorate([
    class_validator_1.IsNotEmpty(),
    __metadata("design:type", String)
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "valuePerItem", void 0);
__decorate([
    class_validator_1.IsNotEmpty(),
    __metadata("design:type", String)
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "totalOrderValue", void 0);
__decorate([
    class_validator_1.IsNotEmptyObject(),
    class_validator_1.ValidateNested({ each: true }),
    class_transformer_1.Type(() => products_1.ProductDTO),
    __metadata("design:type", products_1.ProductDTO)
], CORE_AddEntryDetailsCredentialSubjectDTO.prototype, "product", void 0);
