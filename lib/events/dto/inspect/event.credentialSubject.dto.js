...
], AGENT_InspectCredentialSubjectDTO.prototype, "initiator", void 0);
__decorate([
...
], AGENT_InspectCredentialSubjectDTO.prototype, "place", void 0);
__decorate([
    class_validator_1.IsNotEmptyObject(),
    class_validator_1.ValidateNested({ each: true }),
    class_transformer_1.Type(() => products_1.ProductDTO),
    __metadata("design:type", products_1.ProductDTO)
], AGENT_InspectCredentialSubjectDTO.prototype, "product", void 0);
...
__decorate([
    ...
    __metadata("design:type", String)
], CORE_InspectCredentialSubjectDTO.prototype, "eventId", void 0);
__decorate([
    class_validator_1.IsArray(),
    class_validator_1.ArrayMinSize(1),
    __metadata("design:type", Array)
], CORE_InspectCredentialSubjectDTO.prototype, "type", void 0);
