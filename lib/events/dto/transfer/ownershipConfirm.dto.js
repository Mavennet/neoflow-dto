...
exports.TransferOwnershipConfirmationDTO = exports.TransferOwnershipConfirmation = void 0;
const class_validator_1 = require("class-validator");
const class_transformer_1 = require("class-transformer");
const general_1 = require("../../../general");
const swagger_1 = require("@nestjs/swagger");
class TransferOwnershipConfirmation {
}
__decorate([
...
], TransferOwnershipConfirmation.prototype, "transferOwnershipRequestId", void 0);
__decorate([
...
], TransferOwnershipConfirmation.prototype, "portOfEntry", void 0);
__decorate([
    swagger_1.ApiPropertyOptional(),
    class_validator_1.IsOptional(),
    class_validator_1.IsNotEmptyObject(),
    ...
    class_transformer_1.Type(() => general_1.Place),
    __metadata("design:type", general_1.Place)
], TransferOwnershipConfirmation.prototype, "portOfDestination", void 0);
__decorate([
    swagger_1.ApiPropertyOptional(),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], TransferOwnershipConfirmation.prototype, "countryOfDestination", void 0);
__decorate([
    swagger_1.ApiProperty(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsBoolean(),
    __metadata("design:type", Boolean)
], TransferOwnershipConfirmation.prototype, "confirmationStatus", void 0);
__decorate([
    swagger_1.ApiPropertyOptional(),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], TransferOwnershipConfirmation.prototype, "comment", void 0);
__decorate([
    swagger_1.ApiProperty(),
    ...
    class_validator_1.IsBoolean(),
    __metadata("design:type", Boolean)
], TransferOwnershipConfirmation.prototype, "hasDocuments", void 0);
exports.TransferOwnershipConfirmation = TransferOwnershipConfirmation;
