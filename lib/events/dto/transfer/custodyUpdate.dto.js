...
exports.TransferCustodyUpdateDTO = exports.TransferCustodyUpdate = void 0;
const class_validator_1 = require("class-validator");
const class_transformer_1 = require("class-transformer");
const general_1 = require("../../../general");
const swagger_1 = require("@nestjs/swagger");
class TransferCustodyUpdate {
}
__decorate([
...
], TransferCustodyUpdate.prototype, "requestId", void 0);
__decorate([
    swagger_1.ApiPropertyOptional(),
    class_validator_1.IsOptional(),
    class_validator_1.IsNumberString(),
    __metadata("design:type", String)
], TransferCustodyUpdate.prototype, "contractId", void 0);
__decorate([
    swagger_1.ApiPropertyOptional(),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], TransferCustodyUpdate.prototype, "countryOfDestination", void 0);
__decorate([
    swagger_1.ApiProperty(),
...
], TransferCustodyUpdate.prototype, "portOfEntry", void 0);
__decorate([
    swagger_1.ApiProperty(),
    class_validator_1.IsNotEmptyObject(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => general_1.Place),
    __metadata("design:type", general_1.Place)
], TransferCustodyUpdate.prototype, "portOfDestination", void 0);
__decorate([
    swagger_1.ApiPropertyOptional(),
    class_validator_1.IsOptional(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => general_1.Place),
    __metadata("design:type", general_1.Place)
], TransferCustodyUpdate.prototype, "receiptLocation", void 0);
__decorate([
    swagger_1.ApiProperty(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsString(),
    ...
    __metadata("design:type", String)
], TransferCustodyUpdate.prototype, "receiver", void 0);
__decorate([
    swagger_1.ApiProperty(),
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsBoolean(),
    __metadata("design:type", Boolean)
], TransferCustodyUpdate.prototype, "hasDocuments", void 0);
exports.TransferCustodyUpdate = TransferCustodyUpdate;
