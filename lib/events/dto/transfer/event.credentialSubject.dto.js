...
], TransferEventCredentialSubjectDTO.prototype, "@context", void 0);
__decorate([
    IsArray(),
    ArrayMinSize(1),
    __metadata("design:type", Array)
], TransferEventCredentialSubjectDTO.prototype, "type", void 0);
__decorate([
    IsNotEmpty(),
    IsEnum(EVENT_TYPE),
...
], TransferEventCredentialSubjectDTO.prototype, "eventTime", void 0);
__decorate([
    IsNotEmptyObject(),
    ValidateNested(),
    Type(() => PlaceDTO),
    __metadata("design:type", PlaceDTO)
], TransferEventCredentialSubjectDTO.prototype, "place", void 0);
__decorate([
    IsNotEmptyObject(),
    ValidateNested(),
    Type(() => ProductDTO),
    __metadata("design:type", ProductDTO)
], TransferEventCredentialSubjectDTO.prototype, "product", void 0);
__decorate([
    IsNotEmptyObject(),
    ValidateNested(),
    Type(() => OrganizationDTO),
    __metadata("design:type", OrganizationDTO)
], TransferEventCredentialSubjectDTO.prototype, "initiator", void 0);
__decorate([
    IsNotEmptyObject(),
    ValidateNested(),
    Type(() => OrganizationDTO),
...
__decorate([
    ...
    ValidateIf(o => o.eventType === EVENT_TYPE.TRANSFER_CUSTODY),
    __metadata("design:type", PlaceDTO)
], TransferEventCredentialSubjectDTO.prototype, "recipientLocation", void 0);
__decorate([
    IsNotEmpty(),
    IsNumber(),
