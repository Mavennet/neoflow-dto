...
__decorate([
    ...
    class_validator_1.IsEnum(general_1.EVENT_TYPE),
...
__decorate([
    class_validator_1.IsNotEmptyObject(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => general_1.AddressDTO),
    __metadata("design:type", general_1.AddressDTO)
...
__decorate([
    ...
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => general_1.AddressDTO),
    class_validator_1.ValidateIf(o => o.eventType === general_1.EVENT_TYPE.TRANSFER_CUSTODY),
    __metadata("design:type", general_1.AddressDTO)
], AGENT_TransferEventCredentialSubjectDTO.prototype, "receiptLocation", void 0);
__decorate([
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsNumberString(),
    class_validator_1.ValidateIf(o => o.eventType === general_1.EVENT_TYPE.TRANSFER_OWNERSHIP),
    __metadata("design:type", String)
