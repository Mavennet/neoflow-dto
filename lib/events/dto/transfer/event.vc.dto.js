...
exports.TransferEventVCDTO = void 0;
const class_validator_1 = require("class-validator");
const class_transformer_1 = require("class-transformer");
const general_1 = require("../../../general");
const event_credentialSubject_dto_1 = require("./event.credentialSubject.dto");
class TransferEventVCDTO extends general_1.VerifiableCredentialDTO {
}
__decorate([
...
__decorate([
    ...
    class_validator_1.Validate(o => o.type.includes(general_1.JSON_TYPE.VERIFIABLE_CREDENTIAL) &&
        o.type.includes(general_1.JSON_TYPE_METAL.TRANSFER_EVENT_CREDENTIAL)),
    __metadata("design:type", Array)
], TransferEventVCDTO.prototype, "type", void 0);
__decorate([
    class_validator_1.IsNotEmpty(),
    class_validator_1.ValidateNested(),
    class_transformer_1.Type(() => event_credentialSubject_dto_1.CORE_TransferEventCredentialSubjectDTO),
...
exports.TransferEventVCDTO = TransferEventVCDTO;
