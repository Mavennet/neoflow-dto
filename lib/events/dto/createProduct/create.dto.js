...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CORE_CreateProductDTO.prototype, "workflowId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: [general_1.WrappedEnvelopedVCDTO], description: 'List of wrapped verifiable credentials' }),
    (0, class_validator_1.IsArray)(),
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_transformer_1.Type)(() => general_1.WrappedEnvelopedVCDTO),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", Array)
], CORE_CreateProductDTO.prototype, "vcs", void 0);
