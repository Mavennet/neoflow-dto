...
__decorate([
    ...
    (0, class_validator_1.Validate)(o => o.type.includes(general_1.JSON_TYPE.VERIFIABLE_CREDENTIAL) &&
        o.type.includes(general_1.JSON_TYPE_METAL.CREATION_EVENT_CREDENTIAL)),
    __metadata("design:type", Array)
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => event_credentialSubject_dto_1.CORE_EventCreateCredentialSubjectDTO),
    __metadata("design:type", event_credentialSubject_dto_1.CORE_EventCreateCredentialSubjectDTO)
